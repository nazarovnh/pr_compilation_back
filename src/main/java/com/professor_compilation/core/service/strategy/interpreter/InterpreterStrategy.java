package com.professor_compilation.core.service.strategy.interpreter;
...
public class InterpreterStrategy extends ExecutionStrategy {


    public InterpreterStrategy(IContainerService dockerContainerService, ISolutionAttemptRepository<SolutionAttemptRdbms, String> solutionAttemptRepository, ITaskRepository<Task, String> taskRepository, ITopicRepository<Topic, String> topicRepository, ITopicAccessService topicAccessService) {
